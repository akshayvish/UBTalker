...
namespace First_Attempt
{
    ...
    /// </summary>
    public sealed partial class Home : First_Attempt.Common.LayoutAwarePage
    {
        public Home()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            {
                icon.addHomeCatIcons(AddTile.newTile_Title, AddTile.newTile_Subtitle);
                //Call this again after adding the new tile to the page.
                icon.getEverydayCatIcons(); //NEED TO Change to HOME ICONS
