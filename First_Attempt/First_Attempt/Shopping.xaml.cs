...
namespace First_Attempt
{
    ...
    /// </summary>
    public sealed partial class Shopping : First_Attempt.Common.LayoutAwarePage
    {
        public Shopping()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            //Check if the Add tile was called. If it was then add that tile to the end of the list of tiles already retrieved.
            if ((!string.IsNullOrEmpty(AddTile.newTile_Subtitle))
                || (!string.IsNullOrEmpty(AddTile.newTile_Title)))
            {
                icon.addShoppingCatIcons(AddTile.newTile_Title, AddTile.newTile_Subtitle);
                //Call this again after adding the new tile to the page.
                icon.getShoppingCatIcons();
