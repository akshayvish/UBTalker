...
namespace First_Attempt
{
    ...
    /// </summary>
    public sealed partial class Help : First_Attempt.Common.LayoutAwarePage
    {
        public Help()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            {
                icon.addHelpCatIcons(AddTile.newTile_Title, AddTile.newTile_Subtitle);
                //Call this again after adding the new tile to the page.
                icon.getHelpCatIcons();
